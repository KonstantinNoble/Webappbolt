        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="relative p-3 rounded-full bg-gradient-to-br from-gray-800/80 to-gray-900/80 shadow-lg shadow-cyan-400/20 border-2 border-cyan-400/30">
              {/* Minimalist QuotaSkill Login Magnifying Glass */}
              <div className="relative w-8 h-8">
                <svg viewBox="0 0 100 100" className="w-full h-full">
                  {/* Main Glass Circle - Minimalist gradient */}
                  <circle cx="40" cy="40" r="26" fill="none" stroke="url(#loginGlassGradient)" strokeWidth="4"/>
                  ...
                  {/* Minimalist handle */}
                  <line x1="61" y1="61" x2="84" y2="84" stroke="url(#loginHandleGradient)" strokeWidth="6" strokeLinecap="round"/>
                  <circle cx="78" cy="78" r="3" fill="#6B7280" opacity="0.8"/>
                  
                  {/* Gradients */}
                  <defs>
                    <linearGradient id="loginGlassGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="#06B6D4" />
                      <stop offset="100%" stopColor="#8B5CF6" />
                    </linearGradient>
                    <linearGradient id="loginHandleGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl border border-gray-700 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-4 bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-400 hover:to-purple-400 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 disabled:scale-100"
            >
