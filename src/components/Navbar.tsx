...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            {/* Logo - Exact match from HomePage */}
            ...
            <div className="hidden lg:flex items-center space-x-8">
              <Link 
                ...
                className={`font-medium transition-colors ${
                  isActive('/learning-plans') ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'
                }`}
              >
                Learning Plans
              </Link>
              <Link 
                to="/quiz" 
                className={`font-medium transition-colors ${
                  isActive('/quiz') ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'
                }`}
              >
                Quiz
              </Link>
              <Link 
                to="/learning-hub" 
                className={`font-medium transition-colors ${
                  isActive('/learning-hub') ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'
                }`}
              >
                Learning Hub
              </Link>
      ...
      {/* Sidebar */}
      <div className={`fixed top-0 right-0 h-full w-80 max-w-[90vw] bg-white border-l border-gray-200 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/learning-hub" className="text-gray-600 hover:text-blue-600 font-medium transition-colors">Learning Hub</Link>
